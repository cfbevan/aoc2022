...
class Testday05(TestCase):
    def test_stacks_parse_diagram(self):
        ...
        self.assertEqual(s.stacks, {1: ["Z", "N"], 2: ["M", "C", "D"], 3: ["P"]})

    def test_move(self):
        s = Stacks(input_diagram)
        s.move("move 1 from 2 to 1")
        self.assertEqual(s.stacks, {1: ["Z", "N", "D"], 2: ["M", "C"], 3: ["P"]})
        s.move("move 3 from 1 to 3")
        self.assertEqual(s.stacks, {1: [], 2: ["M", "C"], 3: ["P", "D", "N", "Z"]})
        s.move("move 2 from 2 to 1")
        self.assertEqual(s.stacks, {1: ["C", "M"], 2: [], 3: ["P", "D", "N", "Z"]})
        s.move("move 1 from 1 to 2")
        self.assertEqual(s.stacks, {1: ["C"], 2: ["M"], 3: ["P", "D", "N", "Z"]})
    ...
    def test_move2(self):
        ...
        self.assertEqual(s.stacks, {1: [], 2: ["M", "C"], 3: ["P", "Z", "N", "D"]})
        s.move("move 2 from 2 to 1", True)
        self.assertEqual(s.stacks, {1: ["M", "C"], 2: [], 3: ["P", "Z", "N", "D"]})
        s.move("move 1 from 1 to 2", True)
        self.assertEqual(s.stacks, {1: ["M"], 2: ["C"], 3: ["P", "Z", "N", "D"]})
